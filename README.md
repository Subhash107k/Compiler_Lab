...
- [lab_6/lab_6.yml](lab_6/lab_6.yml)
- [lab_6/README.md](lab_6/README.md)

### Description

Lab 6 computes the FIRST and FOLLOW sets for an expression grammar. It is a direct compiler-design exercise that shows how grammar analysis supports LL(1) parser construction.
...
| Lab 6 | No runtime input; grammar is hardcoded in [lab_6.cpp](lab_6/lab_6.cpp) | FIRST/FOLLOW sets for `E`, `E'`, `T`, `T'`, and `F`                                                                                                                                                                                                      |
